...
export const CLOSER_COACHING: Record<string, PhaseCoaching> = {
  opening: {
    ...
    recommendedPhrases: [
      ...
      '"We\'ve helped thousands of parents across the UK get their children back on track with maths."',
...
We've helped thousands of parents across the UK get their children confident with maths again.
...
How does that sound?"`,
  ...
  clarify: {
    ...
    requiredElements: [
      ...
      'Cover child\'s year group and current subjects',
      'Ask about their goal/success criteria',
      'Uncover urgency trigger ("What made you reach out NOW?")',
    ],
    recommendedPhrases: [
      '"So tell me, what\'s going on with [Child] and maths?"',
      '"What year group is [Child] in and what subjects are they studying?"',
      '"What would success look like for you?"',
      '"What made you decide to reach out NOW vs. waiting until next term?"',
    ...
    exampleScript: `"So tell me, what's going on with Emma and maths?"
[Listen]
"What year group is she in and what subjects is she studying?"
[Listen]
...
"That makes sense. What made you decide to reach out now versus waiting?"`,
  ...
  label: {
    ...
    recommendedPhrases: [
      ...
      '"So what I\'m hearing is that [Child] is in [year group] studying [subjects], and the main challenge is [their words]. Your goal is [their goal]. Is that accurate?"',
    ...
    exampleScript: `"So let me make sure I understand. Emma is in Year 9 studying maths, and she's been struggling with fractions and word problems since last year. It's affecting her confidence and you're worried about her falling behind before GCSEs. Your goal is to get her caught up and feeling confident again before the end of the term. Is that accurate?"`,
  },
  ...
  overview: {
    ...
    recommendedPhrases: [
      '"What have you tried so far to help [Child] with maths?"',
      '"And how did that go?"',
    ...
    exampleScript: `"Before I tell you about what we do, I'm curious - what have you tried so far to help Emma with maths?"
[Listen - e.g., "We tried BBC Bitesize"]
"And how did that go?"
[Listen]
"What else have you tried?"
...
"Anything else?"
[Listen]
"So you've tried BBC Bitesize and a tutor, and neither really solved the problem. Is that fair to say?"
[Confirm]
"How long has this been going on?"
[Listen]
"If nothing changes over the next year, what happens? Where does Emma end up?"`,
  ...
  sell_vacation: {
    ...
    requiredElements: [
      'Lead with teacher credentials (Oxford, Cambridge, UCL, Imperial educated; top 1% of teachers; combined 100+ years experience; screened 3000+)',
      'Bridge from their SPECIFIC pain point',
      'Paint outcome picture (confident child, easier homework - NOT features)',
      'Use relevant proof point matched to their concern',
      'Keep brief - under 3 minutes',
    ],
    recommendedPhrases: [
      '"So here\'s what makes us different. MyEdSpace has teachers educated at Oxford, Cambridge, UCL, and Imperial - the top 1% of teachers - with a combined 100+ years of teaching experience."',
      '"We\'ve personally screened over 3,000 teachers to build our team..."',
    ...
    avoidPhrases: [
      ...
      'Burying the teachers\' credentials',
      'Talking for more than 3 minutes',
    ],
    coachingTip: 'Sell the OUTCOME, not the product. Connect everything back to their specific pain from the Overview phase. The teachers\' credentials should come first - they establish trust before you pitch anything.',
    exampleScript: `"Based on everything you've shared, let me tell you how we can help.

MyEdSpace has teachers educated at Oxford, Cambridge, UCL, and Imperial - the top 1% of teachers - with a combined 100+ years of teaching experience. We've personally screened over 3,000 teachers to build our team.
...
By the end of the term, children like Emma usually go from dreading maths to actually feeling confident enough to raise their hand in class."`,
  },
  ...
  price_presentation: {
    ...
    requiredElements: [
      ...
      'Frame as investment, not cost (£/month breakdown, £/hour)',
    ...
    recommendedPhrases: [
      ...
      '"Most families who are serious about getting results go with our annual plan at £319. That comes out to around £4-5 per hour."',
      '"For the whole school year, that\'s unlimited sessions with our teachers."',
      '"Would that work for your family?"',
      '"If you\'d prefer not to commit to the full year, we also have a monthly option at £80."',
    ],
    avoidPhrases: [
...
"Great! So most families who are serious about getting results go with our annual plan. It's £319 for the whole year - that's unlimited sessions with our teachers, and it works out to around £4-5 per hour.
...
Can I ask - if the investment wasn't a concern, is this something you'd want Emma to have?" [Ask]`,
  ...
  reinforce: {
    ...
    requiredElements: [
      'Follow tiered close: Annual (£319+) → Monthly (£80+) → Trial (£10)',
    ...
    recommendedPhrases: [
      '"Most families who are serious about getting results go with our annual plan at £319. That comes out to around £27 a month and you get unlimited sessions for the whole year."',
      '"Would that work for you, or would you prefer to start with our monthly option at £80?"',
      '"If you want to just try it out first, we also have a £10 10-day trial so [Child] can experience a few sessions."',
...
Most families who are serious about getting results go with our annual plan. It's £319 for the whole year - that's unlimited sessions, comes out to around £27 a month.

Would that work for you?"

[If hesitation]
"If you'd rather not commit to the full year upfront, we also have a monthly option at £80. You can cancel anytime."

[If still hesitating]
"Or if you just want Emma to try it first, we have a £10 10-day trial where she can do a few sessions and see if it's a good fit."
