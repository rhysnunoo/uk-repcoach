...
export const universalScenarios: Scenario[] = [
  ...
  },
  {
    ...
    contextModifier: `You just finished a call with Kumon/Explore Learning before this call. You're comparing options and have their pricing fresh in mind. Ask how MyEdSpace compares. Mention specific things the competitor offered. Be willing to share what you liked/didn't like about the other option if asked.`,
    urgencyLevel: 'medium',
    difficultyModifier: 0.1,
  },
  {
  ...
  skeptical_parent: [
    {
      ...
      contextModifier: `You've tried Kumon (18 months, no results), a private tutor (£40/hour for 6 months, minor improvement), and an online app (Mathway, your child never used it). You're running out of patience AND money. You need to understand exactly why this would be different. Ask very specific questions.`,
      urgencyLevel: 'medium',
